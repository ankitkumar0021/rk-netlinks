            ...
            {milestones.map((milestone, index) => (
              ...
              >
                ...
                <div className="md:hidden flex">
                  ...
                  <div className="absolute left-0 top-6 -ml-3 w-6 h-6 rounded-full bg-blue-600 flex items-center justify-center z-10">
                    <div className="w-2 h-2 rounded-full bg-white"></div>
                  </div>
                  
                  <div className="ml-8 pl-4 w-full">
                    <div className="common_border bg-white p-4 md:p-6 rounded-xl shadow-sm hover:shadow-md transition-all">
                      <div className="flex items-center mb-3">
                        <div className="mr-3">
                          {milestone.icon}
                        </div>
                        <div>
                          <div className="text-xs md:text-sm font-bold text-blue-600">{milestone.year}</div>
                          <h3 className="text-lg md:text-xl font-bold text-gray-800">{milestone.title}</h3>
                        </div>
                      </div>
                ...
                <div className="hidden md:flex md:justify-start">
                  <div className="w-full md:w-5/12">
                    <div className={`common_border bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-all ${index % 2 === 0 ? 'mr-8' : 'ml-8'}`}>
                      <div className="flex items-center mb-4">
                        <div className="mr-4">
                          {milestone.icon}
                        </div>
