...
import { Navigation, Pagination, Autoplay, A11y, Keyboard, EffectCoverflow } from 'swiper/modules';
import 'swiper/css';
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-gray-50 to-blue-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="relative">
          ...
          <div className="absolute -top-2 -left-2 z-20 flex gap-3">
            <button
              ...
              className="bg-white hover:bg-blue-50 w-11 h-11 rounded-full flex items-center justify-center border border-gray-200 hover:border-blue-500 shadow-sm transition"
            >
          ...
          <Swiper
            ...
            modules={[Navigation, Pagination, Autoplay, A11y, Keyboard, EffectCoverflow]}
            spaceBetween={24}
            slidesPerView={1}
            loop={true}
            centeredSlides={false}
            effect="coverflow"
            coverflowEffect={{ rotate: 8, stretch: 0, depth: 100, modifier: 1.2, slideShadows: false }}
          ...
          >
            {testimonials.map((t, idx) => (
              <SwiperSlide key={t.name + idx}>
                <article className="relative bg-white rounded-2xl shadow-lg p-8 border border-gray-100 transition-all duration-300 h-72 flex flex-col justify-between">
                  ...
                  <p className="text-md text-gray-700 italic mb-4 leading-relaxed line-clamp-4">“{t.content}”</p>
        ...
        {/* small pagination hint already provided by swiper bullets; keep spacing */}
      ...
      <style jsx>{`
        ...
        /* reduce coverflow perspective for nicer look on wide screens */
        :global(.swiper) { padding-bottom: 28px; }
      `}</style>
    </section>
  );
};
